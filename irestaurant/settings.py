"""
Django settings for irestaurant project.
...
SECRET_KEY = '0t&phkrp=_%8k@r9%f!p1@l%sl42)!q_t8--9148y$t*^z$5-+'
...
WSGI_APPLICATION = 'irestaurant.wsgi.application'
...
# Configures the path where locale translations are generated
LOCALE_PATHS = (
